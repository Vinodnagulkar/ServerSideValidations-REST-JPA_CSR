...
public class User 
{
	...
	/**
	 * Setter and getters methods of User entity
	 */
	...
	/**
	 *@toString It returns String representation of User object
	 */

	@Override
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", contactNo=" + contactNo + ", email=" + email
